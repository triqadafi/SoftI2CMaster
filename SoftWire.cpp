...
#include "SoftI2CMaster.h"
  ...
  // inline size_t SoftWire::write(unsigned long n) {
  //   return write((uint8_t)n);
  // }
  //
  // inline size_t SoftWire::write(long n) {
  //   return write((uint8_t)n);
  // }
  //
  // inline size_t SoftWire::write(unsigned int n) {
  //   return write((uint8_t)n);
  // }
  //
  // inline size_t SoftWire::write(int n) {
  //   return write((uint8_t)n);
  // }
